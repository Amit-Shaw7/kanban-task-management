              ...
              <Card>
                <form className='p-5 md:py-20 md:px-14 w-full md:w-[500px] flex flex-col gap-3' onSubmit={handleSubmit(onSubmit)}>
                  <div>
                    ...
                    <input type='text' id='name' className={`bg-light dark:bg-dark outline-none p-2 text-black dark:text-white border ${errors.name?.message ? 'border-red' : 'border-dark'} rounded-md w-[100%]`} placeholder='Name' {...register('name')} />
                    <p className='text-red text-xs'>{errors.name?.message}</p>
                  </div>

                  <div>
                    <label htmlFor='email' className='text-black dark:text-white'>Email</label>
                    <input type='email' id='email' className={`bg-light dark:bg-dark outline-none p-2 text-black dark:text-white border ${errors.email?.message ? 'border-red' : 'border-dark'} rounded-md w-[100%]`} placeholder='demo@gmail.com' {...register('email')} />
                  ...
                  <div>
                    ...
                    <input type='password' id='password' className={`font-sans bg-light dark:bg-dark outline-none p-2 text-black dark:text-white border ${errors.password?.message ? 'border-red' : 'border-dark'} rounded-md w-[100%]`} placeholder='*****' {...register('password')} />
